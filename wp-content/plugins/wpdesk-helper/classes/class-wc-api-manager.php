...
//				new WPDesk_API_MENU( $this );
		...
		public function inactive_notice() { ?>
            ...
            <div class="update-nag">
				<?php printf( __( 'The %s%s%s API Key has not been activated, so you won\'t be supported and your plugin won\'t be updated! %sClick here%s to activate the API key and the plugin.',

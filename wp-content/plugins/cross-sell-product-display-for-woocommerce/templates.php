...
function cdxfreewoocross_theme_list_view($products=false){
    ...
    <div class="cdx-theme-list-view">
		...
		<?php foreach($products as $pid): 
				...
				$product_image      = str_replace('?resize=150%2C150&ssl=1', '', wp_get_attachment_image_src( $product->get_image_id()));
		...
		?>        
            ...
            <li> 
              ...
              <img src="<?php echo $product_image; ?>" class="attachment-shop_catalog size-shop_catalog wp-post-image" 
